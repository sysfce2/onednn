...
Eltwise and binary post-ops are supported.
...
~~~cpp
// [total_tokens, N] tensor, that could be either grouped or dense with ab
auto binary_md = /*...*/;
...
- Post-ops: eltwise and binary post-ops are supported. Binary post-op
