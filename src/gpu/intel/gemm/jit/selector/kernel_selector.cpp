...
MatchParamsBase::MatchParamsBase(ngen::HW hw, ngen::PF pf, bool systolicAvailable, bool isIntegrated, const GEMMProblem &problem_)
{
    using namespace kcatalog;
    ...
    ReqBDPASDims = problem.preferBDPAS(pf);
    ...
    problem.autoTypeConversions(pf, systolicAvailable);
