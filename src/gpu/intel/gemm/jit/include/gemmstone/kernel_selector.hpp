...
struct MatchParamsBase
{
    ...
    MatchParamsBase(ngen::HW hw, ngen::PF pf, bool systolicAvailable, bool isIntegrated, const GEMMProblem &problem);
...
{
    MatchParams() = default;
    MatchParams(ngen::HW hw, ngen::PF pf, bool systolicAvailable, bool isIntegrated, const GEMMProblem &problem)
            : MatchParamsBase(hw, pf, systolicAvailable, isIntegrated, problem) {}
